...
def _enrich_stock_response(stock: Stock, db: Session) -> StockResponse:
    ...
    data.today_is_one_word_limit_up = bool(latest_snap.is_one_word_limit_up) if is_today else False
    data.today_is_one_word_limit_down = bool(latest_snap.is_one_word_limit_down) if is_today else False
...
def _enrich_stocks_bulk(stocks: List[Stock], db: Session, as_of_date=None) -> List[StockResponse]:
    ...
    for stock in stocks:
        ...
        data.today_is_one_word_limit_up = bool(snap.is_one_word_limit_up) if is_today else False
        data.today_is_one_word_limit_down = bool(snap.is_one_word_limit_down) if is_today else False
