...
def init_db():
    from .models import stock, sector, review, screening, regulatory, market_index, app_config, trade_journal, market_effect, weak_to_strong_radar  # noqa: F401 - imports trigger table registration
