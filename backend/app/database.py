...
def init_db():
    from .models import stock, sector, review, screening, regulatory, market_index, app_config, trade_journal, market_effect, weak_to_strong_radar, limit_up_detail, leader_cycle, pre_trade_check  # noqa: F401 - imports trigger table registration
...
def _apply_schema_patches():
    ...
    patches = [
        ...
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS rs_sector_source VARCHAR(10)",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS market_sessions INTEGER",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS absent_days INTEGER",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS suspended_days INTEGER",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS latest_bar_date DATE",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS data_fresh BOOLEAN",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS rs_market_20_delta_1d DOUBLE PRECISION",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS rs_market_20_delta_3d DOUBLE PRECISION",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS rs_sector_20_delta_1d DOUBLE PRECISION",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS dist_to_post_break_high DOUBLE PRECISION",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS dist_to_cycle_peak DOUBLE PRECISION",
        "ALTER TABLE leader_cycle_snapshots ADD COLUMN IF NOT EXISTS new_post_break_high_today BOOLEAN",
