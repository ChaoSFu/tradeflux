...
from .routers import stocks, sectors, reviews, market_state, screening, admin, auth, watchlist, market_index, trade_journal, market_effects, turnover, weak_to_strong_radar, limit_up_radar, speculation_radar, leader_cycle, pre_trade_check, data_audit, sector_trend
...
app.include_router(data_audit.router, prefix=settings.API_PREFIX)
app.include_router(sector_trend.router, prefix=settings.API_PREFIX)
